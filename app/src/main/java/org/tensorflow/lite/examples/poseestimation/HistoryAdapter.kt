...
class HistoryAdapter(private val onClick: (Workout) -> Unit) :
    ...
    class HistoryViewHolder(itemView: View, val onClick: (Workout) -> Unit): RecyclerView.ViewHolder(itemView){
            ...
            private val icon : ImageView = itemView.findViewById(R.id.workout)
            ...
            fun bind(workout: Workout){
                ...
                if (workout.type == "SQUATS"){
                    icon.setImageResource(R.drawable.ic_standing)
                }
                else{
                    icon.setImageResource(R.drawable.ic_push_up)
                }
            }
